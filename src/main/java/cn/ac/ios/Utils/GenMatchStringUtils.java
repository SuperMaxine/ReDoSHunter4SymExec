...
//    }
    ...
    public static Pair<String, SmtNode> getExampleByDkBricsAutomaton2(List<String> regexList, int minLength) throws InterruptedException {
...
//            String regex = repairLineFeedsCarriageReturnsAndTabCharacters(regexList.get(i));
        ...
        return new Pair<>(getCommonMatchString(automatonList, minLength), new SmtNode(regexList));
    }
