...
public final class Matcher implements MatchResult {
     ...
     * @see engine.regex.Matcher#useTransparentBounds(boolean)
     * @since 1.5
     */
     ...
     *         regions
     * @return this matcher
     * @see engine.regex.Matcher#hasTransparentBounds
     * @since 1.5
     */
     ...
     *         <tt>false</tt> otherwise.
     * @see engine.regex.Matcher#useAnchoringBounds(boolean)
     * @since 1.5
     */
     ...
     * @return this matcher
     * @see engine.regex.Matcher#hasAnchoringBounds
     * @since 1.5
     */
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("engine.regex.Matcher");
